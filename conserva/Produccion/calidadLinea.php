...
<div class="content-wrapper" style="min-height: 322.233px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Calidad Linea</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Complete los siguientes valores</h5>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                 <table class="table table-bordered table-responsive{-sm|-md|-lg|-xl}">
                  ...
                  <tbody>
                    <tr>
                      <td>Peso Neto</td>
                      <td><input type="text" name="calices" id="ax_calices" value="" class="form-control"></td>
                    </tr>
                    <tr>
                      <td>Peso Llenado</td>
                ...
                <table class="table table-bordered table-responsive{-sm|-md|-lg|-xl}">
                  ...
                  <tbody>
                      <tr>
                      <td>Partes o Trozos Vegetales</td>
                      <td><input type="text" name="calices" id="" value="" class="form-control"></td>
                    </tr>
                      <tr>
                      <td>% Unidades Trituradas o Rotas</td>
                      <td><input type="text" name="calices" id="" value="" class="form-control"></td>
                    </tr>
                      <tr>
                      <td>% Manchas</td>
                      ...
                      <tr>
                      <td>% Total Und. Defectuosas</td>
                      <td><input type="text" name="calices" id="" value="" class="form-control"></td>
                    </tr>
                      <tr>
                      <td>Diferencia Tamaño</td>
                      <td><input type="text" name="calices" id="" value="" class="form-control"></td>
                    </tr>
                      <tr>
                      <td>Observaciones</td>
                ...
                <div class="card-footer">
                  <button type="submit" id="btn_ingresar" class="btn btn-success" >Grabar</button>
